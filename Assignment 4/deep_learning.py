...
def build_model(n_hidden, n_neurons_hidden, n_neurons_output, learning_rate):
    ...
    #output layer
    model.add(keras.layers.Dense(n_neurons_output, activation="softmax"))  # output layer                #output layer with one neural for each class and the softmax activation function since the classes are exclusive
...
highestAccuracy = 0.0  # Initialize highest accuracy
best_params = (0, 0, 0)  # Initialize best parameters
